    ...
    <>
      {!userAccount ? (
        ...
        <div className="checkoutFormDiv">
          <h2 className="checkoutHeader">Please enter a shipping address</h2>
          <form onSubmit={handleSubmit} className="checkoutForm">
            <label>Street Address:</label>
            <input className="addressInput" required></input>
            ...
            <br />
            <button className="finalSubmitButton">Submit your order</button>
          </form>
        </div>
      )}
